...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('candidate_vetting', '0005_alter_scorefactor_unique_together'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dist_edge_flg', models.CharField(blank=True, max_length=2, null=True)),
        ...
        migrations.CreateModel(
            name='ZtfVarstarQ3C',
            fields=[
                ('id', models.CharField(blank=True, max_length=22, primary_key=True, serialize=False)),
