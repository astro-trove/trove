...
class Hecate2Q3C(models.Model):
    ...
    decdeg = models.FloatField(blank=True, null=True)
    ...
    logmstarswhec = models.FloatField(blank=True, null=True)
    ...
    metal = models.FloatField(blank=True, null=True)
    nmetal = models.CharField(max_length=64, blank=True, null=True)
